              ...
              { !(flashcard == {}) ? <Card>
                ...
                <ul className="grid gap-3">
                    ...
                    <span className="text-muted-foreground">A: {flashcard.cards[index].choices.A}</span>
                          ...
                          {flashcard.cards[index].correct == "A" ? <Check/> : null}
                          {flashcard.cards[index].correct != flashcard.cards[index].chosen && flashcard.cards[index].chosen == "A" ? <X/> : null}
                    </li>
                    <li className="flex items-center justify-between">
                      ...
                      {flashcard.cards[index].chosen == "B" ? "Your Answer" : null}
                          {flashcard.cards[index].correct == "B" ? <Check/> : null}
                          {flashcard.cards[index].correct != flashcard.cards[index].chosen && flashcard.cards[index].chosen == "B" ? <X/> : null}
                    </li>
                    <li className="flex items-center justify-between">
                      ...
                      {flashcard.cards[index].chosen == "C" ? "Your Answer" : null}
                          {flashcard.cards[index].correct == "C" ? <Check/> : null}
                          {flashcard.cards[index].correct != flashcard.cards[index].chosen && flashcard.cards[index].chosen == "C" ? <X/> : null}
                    </li>
                    <li className="flex items-center justify-between">
                      <span className="text-muted-foreground">D: {flashcard.cards[index].choices.D}</span>
                          ...
                          {flashcard.cards[index].correct == "D" ? <Check/> : null}
                          {flashcard.cards[index].correct != flashcard.cards[index].chosen && flashcard.cards[index].chosen == "D" ? <X/> : null}
                    </li>
                  </ul>
                </CardContent>
