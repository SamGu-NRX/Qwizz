        ...
        <div className="grid w-full auto-rows-[20rem] grid-cols-1 gap-5 md:grid-cols-12">
          {features.map((feature, index) => (
            <CardSpotlight
              ...
              className={twMerge(
                "group relative flex transform-gpu md:p-3 lg:p-5 flex-col justify-between overflow-hidden rounded-2xl duration-300 ease-in-out",
                index % 2 === 0
            ...
            >
              ...
              <div className="md:-ml-3 lg:-ml-5 absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                <a
                  href={feature.link}
