...
const onClick = (provider: 'github' | 'google' | 'discord') => {
  signIn(provider, {
        ...
        <>
          ...
          <dialog id="my_modal_2" className="modal text-baseContent bg-base100/10">
            <div className="modal-box text-baseContent bg-base100">
              ...
              {/* TODO: Add loading functionality for OAuth Buttons */}

              <GoogleSignInButton buttonText='Continue with Google' handleClick={() => onClick('google')} />
              <DiscordSignInButton buttonText='Continue with Discord' handleClick={() => onClick('discord')} />
              <GithubSignInButton buttonText='Continue with Github' handleClick={() => onClick('github')} />
            </div>
