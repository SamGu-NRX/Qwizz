...
const DialogClose = <DialogPrimitive.Close className="bg-white text-white fill-white color-[#ffffff]"/> ;
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/70 backdrop-blur-sm transition-all data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:fade-in data-[state=closed]:duration-100 data-[state=open]:duration-100",
      className
    )}
    {...props}
  />
